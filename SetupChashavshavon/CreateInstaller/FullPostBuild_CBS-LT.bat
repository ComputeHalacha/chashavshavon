...
"C:\Program Files\7-Zip\7z.exe " a "C:\repos_git\Compute\WebSite\Products\Chashavshavon\Chashavshavon_Installer_Full.zip" "Chashavshavon_Installer_Full.exe"
DEL "Chashavshavon_Installer_Full.exe"
"SetVersionApp.exe " "c:\repos_git\Chashavshavon\Chashavshavon\bin\%~2\Chashavshavon.exe" "c:\repos_git\Compute\WebSite\Products\Chashavshavon"